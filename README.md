...
```
cd existing_repo
git remote add origin https://gitlab.com/alexandresantoscompunb/simulacao_cenarios.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/alexandresantoscompunb/simulacao_cenarios/-/settings/integrations)
